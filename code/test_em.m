...
scatter(Data_f1(:,1), ones(size(Data_f1(:,1),1),1), 10,  'MarkerEdgeColor', [0 1 0], 'MarkerFaceColor',[0 1 0], 'LineWidth',1.5);
scatter(Data_f2(:,1), ones(size(Data_f2(:,1),1),1), 10, 'MarkerEdgeColor', [0 0 1], 'MarkerFaceColor',[0 0 1], 'LineWidth',2);
scatter(Data_f3(:,1), ones(size(Data_f3(:,1),1),1), 10,'MarkerEdgeColor', [0 0 0], 'MarkerFaceColor',[0 0 0], 'LineWidth',2.5);
scatter(Data_f4(:,1), ones(size(Data_f4(:,1),1),1), 10,'MarkerEdgeColor', [0 1 1], 'MarkerFaceColor',[0 1 1], 'LineWidth',3);
scatter(Data_f5(:,1), ones(size(Data_f5(:,1),1),1), 10,  'MarkerEdgeColor', [1 1 0], 'MarkerFaceColor',[1 1 0], 'LineWidth',3.5);
scatter(Data_f6(:,1), ones(size(Data_f6(:,1),1),1), 10, 'MarkerEdgeColor', [1 1 1], 'MarkerFaceColor',[1 1 1], 'LineWidth',4);
scatter(Data_f7(:,1), ones(size(Data_f7(:,1),1),1), 10, 'MarkerEdgeColor', [1 0 1], 'MarkerFaceColor',[1 0 1], 'LineWidth',4.5);
scatter(Data_f8(:,1), ones(size(Data_f8(:,1),1),1), 10, 'MarkerEdgeColor', [0.5 0.5 0.5], 'MarkerFaceColor',[0.5 0.5 0.5], 'LineWidth',5);
scatter(Data_f9(:,1), ones(size(Data_f9(:,1),1),1), 10, 'MarkerEdgeColor', [0.5 0.0 0], 'MarkerFaceColor',[0.5 0 0], 'LineWidth',5.5);
